...
struct contabancaria *cria_conta(int numeroConta, float saldoConta,char titularConta[]) {
...
void transfere(struct contabancaria *conta_origem, struct contabancaria *conta_destino, int valor) {
